          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="flex items-center justify-center rounded-lg bg-gray-800 p-2 text-white transition hover:bg-blue-600"
                title="GitHub"
                aria-label="GitHub"
              >
              ...
              <a
                ...
                className="flex items-center justify-center rounded-lg bg-gray-800 p-2 text-white transition hover:bg-pink-500"
                title="Instagram"
              ...
              <a
                ...
                className="flex items-center justify-center rounded-lg bg-gray-800 p-2 text-white transition hover:bg-black"
                title="TikTok"
                aria-label="TikTok"
              >
              ...
              <a
                ...
                className="flex items-center justify-center rounded-lg bg-gray-800 p-2 text-white transition hover:bg-blue-700"
                title="Facebook"
                aria-label="Facebook"
              >
