  ...
  const posts = [
    {
      ...
      date: 'May 2024',
      excerpt: 'Learn how to optimize your workouts by understanding different heart rate zones and how ApexCardio helps you stay in the right zone.',
      category: 'Health Tips'
    },
    {
      title: 'The Science Behind Heart Rate Variability',
      date: 'April 2024',
      excerpt: 'Discover what heart rate variability means and how it can be an indicator of your overall fitness and stress levels.',
      category: 'Science'
    },
    {
      title: 'ApexCardio 2.0 Launch: New Features',
      date: 'March 2024',
      excerpt: 'Exciting new updates include improved analytics, custom notifications, and integration with popular fitness apps.',
      category: 'Product'
    },
    {
      title: 'How to Track Your Progress Over Time',
      date: 'February 2024',
      excerpt: 'Get the most out of ApexCardio by learning how to analyze your health trends and set achievable fitness goals.',
      category: 'Tutorial'
    }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-linear-to-br from-blue-50 to-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">ApexCardio Blog</h1>
          <p className="text-xl text-gray-600">Tips, insights, and updates on cardiovascular health and fitness.</p>
        </div>
      </section>
          ...
          <div className="grid gap-8">
            {posts.map((post, idx) => (
              <article key={idx} className="border-b border-gray-200 pb-8 last:border-b-0">
                ...
                <a href="#" className="text-blue-600 font-semibold hover:text-blue-700 transition">Read More →</a>
              </article>
            ))}
          </div>
        </div>
