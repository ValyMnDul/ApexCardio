      ...
      <section className="bg-linear-to-br from-blue-50 to-white pt-20 pb-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-linear-to-br from-blue-100 to-blue-50 rounded-2xl aspect-square flex items-center justify-center overflow-hidden">
              <Image
                src="/a.jpeg"
                alt="ApexCardio Prototype"
                width={500}
                height={500}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Get concise daily summaries of your heart metrics and trends to stay informed.',
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12h3l2 8 4-16 3 12 2-4h3" />
                  </svg>
                )
              },
              {
