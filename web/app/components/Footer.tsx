        ...
        <div className="grid gap-8 mb-12 md:grid-cols-4">
          <div>
            <div className="mb-4 flex items-center space-x-3">
              <Image src="/ico.png" alt="ApexCardio" width={40} height={40} className="rounded-lg shadow" />
              <span className="text-lg font-bold text-white">ApexCardio</span>
            </div>
            <p className="text-sm leading-relaxed text-gray-400">Advanced cardiovascular health monitoring for everyone.</p>
          </div>
